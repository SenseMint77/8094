...
from model.layers import HGNNLayer
import math
...
class ATT(nn.Module):
    def __init__(self, input_size, n_hid, output_size, dropout=0.3):
        ...
        self.gat1 = HGNNLayer(input_size, n_hid, dropout=self.dropout, alpha=0.2, transfer=False,
                                                   concat=True)
        self.gat2 = HGNNLayer(n_hid, output_size, dropout=self.dropout, alpha=0.2, transfer=True,
                                                   concat=False)
